...
use iota_streams::app::transport::tangle::client::iota_client::ClientBuilder as ClientBuilderRust;
...
impl ClientBuilder {
    ...
    pub fn node(mut self, node: &str) -> ClientBuilder {
        self.0 = self.0.with_node(node).unwrap();
        self
    }
    ...
    pub fn with_nodes(mut self, urls: Vec<JsString>) -> ClientBuilder {
        let url_str: Vec<String> = urls.into_iter().map(|s| s.into()).collect();
        self.0 = self
            .0
            .with_nodes(&url_str.iter().map(|s| s as &str).collect::<Vec<&str>>())
            .unwrap();
        self
    }
    ...
    pub fn with_quorum(mut self, quorum_on: bool) -> ClientBuilder {
        self.0 = self.0.with_quorum(quorum_on);
        self
    }
    ...
    pub fn with_quorum_size(mut self, quorum_size: usize) -> ClientBuilder {
        self.0 = self.0.with_quorum_size(quorum_size);
        self
    }
    ...
    pub fn with_quorum_threshold(mut self, quorum_threshold: usize) -> ClientBuilder {
        self.0 = self.0.with_quorum_threshold(quorum_threshold);
        self
    }
    ...
    pub fn with_network(mut self, network: &str) -> ClientBuilder {
        self.0 = self.0.with_network(network);
        self
    }
    ...
    pub fn with_node_sync_disabled(mut self) -> ClientBuilder {
        self.0 = self.0.with_node_sync_disabled();
        self
    }
    ...
    pub fn with_offline_mode(mut self) -> ClientBuilder {
        self.0 = self.0.with_offline_mode();
        self
    }
    ...
    pub fn with_request_timeout(mut self, timeout_sec: u64) -> ClientBuilder {
        self.0 = self.0.with_request_timeout(Duration::from_secs(timeout_sec));
        self
    }
    ...
    pub fn with_api_timeout(mut self, api: Api, timeout_sec: u64) -> ClientBuilder {
        self.0 = self.0.with_api_timeout(api.into(), Duration::from_secs(timeout_sec));
        self
    }
    ...
    pub fn with_local_pow(mut self, local: bool) -> ClientBuilder {
        self.0 = self.0.with_local_pow(local);
        self
    }
    ...
    pub fn with_tips_interval(mut self, tips_interval: u64) -> ClientBuilder {
        self.0 = self.0.with_tips_interval(tips_interval);
        self
    }
    ...
    pub async fn finish(self, options: SendOptions) -> Client {
        new_with_client(self.0.finish().await.unwrap(), options)
    }
}
