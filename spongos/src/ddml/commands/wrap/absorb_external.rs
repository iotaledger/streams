...
/// Absorbs a single byte encoded [`Uint8`] into [`Spongos`] state but does not advance internal stream.
...
/// Absorbs a two byte encoded [`Uint16`] into [`Spongos`] state but does not advance internal stream.
...
/// Absorbs a four byte encoded [`Uint32`] into [`Spongos`] state but does not advance internal stream.
...
/// Absorbs an eight byte encoded [`Uint64`] into [`Spongos`] state but does not advance internal stream.
...
/// Absorbs an `n` byte encoded [`Size`] into [`Spongos`] state but does not advance internal stream.
...
/// Absorbs an `n` byte encoded [`NBytes`] into [`Spongos`] state but does not advance internal stream.
...
/// Absorbs a 32 byte Ed25519 Public Key into [`Spongos`] state but does not advance internal stream.
...
/// Absorbs a 32 byte X25519 Public Key into [`Spongos`] state but does not advance internal stream.
