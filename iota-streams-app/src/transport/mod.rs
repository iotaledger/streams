...
// #[async_trait]
// impl<Link, Tsp: TransportDetails<Link>> TransportDetails<Link> for Rc<RefCell<Tsp>> where Link: Sync{
...
// #[async_trait]
// impl<Link, Msg, Tsp: Transport<Link, Msg>> Transport<Link, Msg> for Rc<RefCell<Tsp>> where Msg: Sync, Link: Sync, Tsp: Send {
//     // Send a message.
//     async fn send_message(&mut self, msg: &Msg) -> Result<()> {
...
//     #[async_trait]
//     impl<Link, Msg, Tsp: Transport<Link, Msg>> Transport<Link, Msg> for Arc<Mutex<Tsp>> where Tsp: Send, Msg: Sync {
//         // Send a message.
//         async fn send_message(&mut self, msg: &Msg) -> Result<()> {
