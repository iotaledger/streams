...
/// * `b` -- output buffer.
///
pub fn wrap(msgid: TritSlice, slink: &mut Spongos, s: &mut Spongos, b: &mut TritSliceMut) {
...
///
pub fn unwrap(
    lookup_link: impl Fn(TritSlice) -> Option<(Spongos, ntru::PublicKey)>,
    s: &mut Spongos,
    b: &mut TritSlice,
