...
fn mss_troika_benchmark(c: &mut Criterion) {
    mss_benchmark::<mss::troika::ParametersMtTraversal<Trit>>(c, "Troika");
    mss_benchmark::<mss::troika::ParametersMtComplete<Trit>>(c, "Troika");
}

criterion_group!(benches, mss_troika_benchmark);
